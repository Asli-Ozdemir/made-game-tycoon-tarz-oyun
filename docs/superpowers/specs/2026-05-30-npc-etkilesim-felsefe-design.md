...
**🗼 Cassian — melankolik.** T1: "...Geldin demek." · "Üç gemiye yol gösterdim, hiçbiri durmadı." · "Deniz kurşun rengi, bana uygun." · "Uyumadım, karanlık benimle konuşuyor." · "Acele et, ışığı yakmam lazım." — T2: "Bir zamanlar biri vardı, sonra olmadı." · "Yalnızlığı seçtim sandım; o beni seçmiş." — T3 (flört): "Kendi limanımı bulamadım; sen geldiğinden beri ışık içeride de yanıyor." · "Karanlığımdan kaçmadın, ilk sen."
...
**🎣 Pjotr.** T1: "Naber genç, otur — deniz kimseyi kovmaz." · "Oltada yem bile yok, söyleme." · "Acelen ne? Deniz hep burada." · "Otto yine ekmek bırakmış, görmezden geliyorum." · "Theo'yla suskun otururuz." — T2: "Atölyem battı, işimi adımı kaybettim, sonra denize baktım." · "Boş günün de tadı var." — T3: "Bir gün dur, denize bak; kaybettiğini sandığın orada değil." · "Yarın yine gel, yanında biri olması iyi."
