...
| 3 | **NPC Yaşam Olayları (B)** → 🟡 revize edilip kısmen uygulandı (2026-06-06). **Minör/yeni-nesil cohort (4):** Tessa (programcı, 18'inde→hireable + employeeStore adayı), Bea (sanatçı, 18'inde→`bea_mural_yapildi` flag), Pip & Otto (çocuklar, yıllarca büyür). `npcToCandidate` + lifeStore hireable enjeksiyonu aktif. Eski spec roster'ı (Tomas/Hanna/Wilhelm...) bizde yoktu; gerçek roster'a uyarlandı. **Kalan (sonraya):** evlilik (Daniel&Sigrid), ölüm+miras (Aldo→Rosa), cutscene/diyalog-override zenginliği. | `specs/2026-05-31-npc-yasam-olaylari-design.md` | `plans/2026-05-31-npc-yasam-olaylari.md` |
